...
class BedrockAgent:
    ...
    def generate_response(self, user_input: str) -> Dict[str, Any]:
        ...
        Returns:
            ...
            - cleaned_memory: bool indicating if memory was cleaned
        """
        try:
            ...
            return {
                "success": True,
                "response": self._format_response(response_str),
...
if __name__ == "__main__":
    ...
    # First query (valid SQL)
    result1 = agent.generate_response("tell me how many customers are there")
    print(result1)
    
    # Second query (non-SQL)
    result2 = agent.generate_response("Tell me a joke")
    print(result2)  # Memory will be cleaned automatically
    
    # Third query (will use cleaned memory)
    result3 = agent.generate_response("tell me the customers with first name start from 'J'")
    print(result3)