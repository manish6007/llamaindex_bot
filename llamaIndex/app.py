...
# ------------------------ LLM Setup --------------------------
llm = Bedrock(model="anthropic.claude-3-5-sonnet-20241022-v2:0", temperature=0, region_name="us-east-1",context_size=4096)
Settings.llm = llm
...
mem = agent_memory.composable_memory()
agent = ReActAgent(
...
print(f"memory:{mem.get()}")

# ----------------------- Chat + Evaluate ----------------------
query = "Show top 5 customers with most orders"
response = agent.chat(query)
print("\nAgent Response:\n", response)
print(f"memory:{mem.get()}")

query = "Tell me the customers with first name 'John'"
response = agent.chat(query)
print("\nAgent Response:\n", response)
print(f"memory:{mem.get()}")

query = "Tell me the customers with first name start from 'J'"
response = agent.chat(query)
print("\nAgent Response:\n", response)
print(f"memory:{mem.get()}")

# Evaluation with RAGAS
# ragas_embedder = BedrockLangchainEmbedding(embed_model)
